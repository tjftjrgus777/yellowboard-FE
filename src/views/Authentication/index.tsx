    ...
    const SignUpCard = () => {
        ...
        const onNextButtonClickHandler = () => {
            ...
            if (!isCertificationCheck) {
                setCertificationNumberError(true);
                setCertificationCheck(false);
                setCertificationNumberMessage('인증번호를 확인해주세요.');
                return;
            }
            ...
            if (!isCheckedPassword) {
                setPasswordError(true);
                setpasswordErrorMessage('유효하지 않은 비밀번호입니다. 8~20자의 영문자와 숫자를 필수로 포함해야 합니다');
                return;
            }
            ...
            // if (!isEmailCheck || isCertificationCheck || !isCheckedPassword || !isEqualPassword) return;
        ...
        const onSignUpButtonClickHandler = () => {
            ...
            const requestbody: SignUpRequestDto = {
                email, password, certificationNumber, nickname, telNumber, address, addressDetail, agreedPersonal
            };
                        ...
                        {page === 1 &&
                            <>
                                ...
                                <InputBox ref={emailRef} label={'이메일 주소 *'} type='text' placeholder='이메일 주소를 입력헤주세요'
                                    ...
                                    buttonTitle='이메일 인증' onButtonClick={onEmailButtonClickHanlder}
                                />
